...
from Pandora_Houdini_Functions import Pandora_Houdini_Functions
from Pandora_Houdini_Integration import Pandora_Houdini_Integration


class Pandora_Plugin_Houdini(Pandora_Houdini_Variables, Pandora_Houdini_externalAccess_Functions, Pandora_Houdini_Functions, Pandora_Houdini_Integration):
	def __init__(self, core):
		Pandora_Houdini_Variables.__init__(self, core, self)
		Pandora_Houdini_externalAccess_Functions.__init__(self, core, self)
		Pandora_Houdini_Functions.__init__(self, core, self)
